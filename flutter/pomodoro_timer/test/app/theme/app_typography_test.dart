  ...
  group('AppTypography', () {
    ...
    group('createTextTheme', () {
      ...
      test('displayLarge uses largeTitle style', () {
        ...
        expect(textTheme.displayLarge?.fontSize, AppTypography.largeTitle.fontSize);
        expect(textTheme.displayLarge?.fontWeight, AppTypography.largeTitle.fontWeight);
      });
      ...
      test('displayMedium uses title style', () {
        ...
        expect(textTheme.displayMedium?.fontWeight, AppTypography.title.fontWeight);
      });
      ...
      test('labelLarge uses button style', () {
        ...
        expect(textTheme.labelLarge?.fontWeight, AppTypography.button.fontWeight);
      });
    });
    ...
    group('withColor', () {
      ...
      test('preserves other style properties', () {
        ...
        expect(coloredStyle.fontFeatures, contains(const FontFeature.tabularFigures()));
      });
    });

    group('Font hierarchy', () {
      test('font sizes follow proper hierarchy', () {
        expect(AppTypography.largeTitle.fontSize, greaterThan(AppTypography.title.fontSize!));
        expect(AppTypography.title.fontSize, greaterThan(AppTypography.title2.fontSize!));
        expect(AppTypography.title2.fontSize, greaterThan(AppTypography.title3.fontSize!));
        expect(AppTypography.title3.fontSize, greaterThan(AppTypography.headline.fontSize!));
        expect(AppTypography.headline.fontSize, equals(AppTypography.body.fontSize));
        expect(AppTypography.body.fontSize, greaterThan(AppTypography.callout.fontSize!));
        expect(AppTypography.callout.fontSize, greaterThan(AppTypography.subheadline.fontSize!));
        expect(AppTypography.subheadline.fontSize, greaterThan(AppTypography.footnote.fontSize!));
        expect(AppTypography.footnote.fontSize, greaterThan(AppTypography.caption.fontSize!));
      });

      test('timerFont is largest', () {
        expect(AppTypography.timerFont.fontSize, greaterThan(AppTypography.largeTitle.fontSize!));
      });
    });
