...
- ❌ **No Network Requests**: The app does not make network requests
...
- Data is automatically backed up with your device's backup (controlled by your device settings)
